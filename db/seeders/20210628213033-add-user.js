...
module.exports = {
  up: (queryInterface, Sequelize) => {
    ...
    return queryInterface.bulkInsert('Users', [
      ...
      { username: 'DemoUser', firstName: 'Phineas', lastName: 'Fogg', email: 'around@world.com', hashedPassword: '$2a$10$2IvS3F2alK7ZAZCbdwljW.Vg79KD7Dcn9RiGFcmAuOc17h0l91VdS', createdAt: new Date(), updatedAt: new Date() },
    ], {});
  },
